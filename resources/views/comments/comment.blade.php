        ...
        <div class="flex justify-center pt-3">
            <form action="{{ route('comment.send') }}" method="POST">
                ...
                <div class="block">
                    ...
                    <div>
                        <label for="comment" class="text-lg">Feedback</label>
                        <textarea id="comment" name="comment" class="block shadow-5xl p-2 my-3 w-full" rows="4"
                            cols="50" placeholder="Leave Your Message Here" value="{{old('comment')}}"></textarea>
                    </div>
